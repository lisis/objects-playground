...
let otro_gato = {
    nombre: "John",
    edad: 1,
    latas_favoritas: ["Whiskas"],
    cumplegato: function () {
        this.edad++
    },
    nuevaLataFavorita: function (nombreLata) {
        this.latas_favoritas.push(nombreLata);
    }
}
...
// el gato ahora le gusta también la marca "Royal Canin"
otro_gato.nuevaLataFavorita("Royal Canin");
console.log("Latas favoritas del gato: ", otro_gato.latas_favoritas);
